...
#define CMD0    (0x40+0)        /* GO_IDLE_STATE            */ // 0x49
#define CMD1    (0x40+1)        /* SEND_OP_COND (MMC)       */ // 0x41
#define ACMD41  (0xC0+41)       /* SEND_OP_COND (SDC)       */ // 0xE9
#define CMD8    (0x40+8)        /* SEND_IF_COND             */ // 0x48
#define CMD9    (0x40+9)        /* SEND_CSD                 */ // 0x49
#define CMD16   (0x40+16)       /* SET_BLOCKLEN             */ // 0x50
#define CMD17   (0x40+17)       /* READ_SINGLE_BLOCK        */ // 0x51
#define CMD24   (0x40+24)       /* WRITE_SINGLE_BLOCK       */ // 0x58
#define CMD42   (0x40+42)       /* LOCK_UNLOCK              */ // 0x6A
